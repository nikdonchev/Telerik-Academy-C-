...
public class MinMaxSumAvr
{
    ...
    private static int Min(params int[] sequence)
    {
    ...
    private static int Max(params int[] sequence)
    {
        int sequenceLength = sequence.GetLength(0);
        if (sequenceLength > 0)
        {
    ...
    private static int Sum(params int[] sequence)
    {
        int sum = 0;
    ...
    private static int Average(params int[] sequence)
    {
    ...
    private static int Product(params int[] sequence)
    {
